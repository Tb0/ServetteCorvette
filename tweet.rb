...
consumer_key = OAuth::Consumer.new(
  "KuaWYqITwn4ckBJXy8sEQ",
  "S4Mu81SPLK06ZwSxqs2CQ2nv14yeArHHosRS9gW20")
access_token = OAuth::Token.new(
  "309561874-4yzIg81oQWQgmaEisOSdN82dYNQEG8V5Xfh2BEmI",
  "6xrQobecQu2w24gsROcJ8RM3VuztnoULU4wa0MFS62w")
...
request.set_form_data(
  "status" => "I'm now tweeting from the Twitter API",
)
